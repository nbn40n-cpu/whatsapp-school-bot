...
let FAMILY_NUMBERS = ["972569842124", "0569268867"];
let FAMILY_NAMES = { "972569842124": "نهال أم محمد", "0569268867": "هدى أم آدم" };
...
const TRAINER_FAREWELLS = [
  ...
  "مع السلامة يا استاذ {name}، الله يحفظك ويعطيك العافية، نورتنا دائماً."
];
const BOSS_OWNER_REPLY = "الاستاذ سمير مشغول ربما بالتدريب أو بأعمال أخرى، رح يرجعلك بأقصى سرعة.";
const BOSS_GREETING_VARIANTS = [
  "أهلاً وسهلاً أبو حسين، حياك الله يا حج بديع، كيفك شو أخبارك؟ الله يطول عمرك ويعطيك الصحة، أنا المساعدة للاستاذ سمير، شو بقدر أساعدك تفضل أبو حسين؟",
  "حياك الله منور أبو حسين، اهلاً وسهلاً فيك يا حج، الله يقويك ويعطيك العافية، كيف صحتك شو أخبارك؟ أنا المساعدة للاستاذ سمير، تفضل أبو حسين شو بneedي؟",
  "صباح النور منور أبو حسين، أهلاً وسهلاً يا حج بديع، الله يطول بعمرك ويعطيك الصحة، كيفك شو أخبارك؟ أنا المساعدة للاستاذ سمير، شو بقدر أساعدك؟",
  "مرحبا هلا مرحبتين أبو حسين، حياك الله يا حج، الله يسعدك ويديم صحتك، كيف حالك شو أخبارك؟ أنا المساعدة للاستاذ سمير، شو بneedي تفضل؟",
  "أهلاً وسهلاً أبو حسين، اهلين وسهلين فيك يا حج بديع، الله يطول عمرك ويعطيك ألف صحة، كيفك شو أخبارك؟ أنا المساعدة للاستاذ سمير، شو بقدر أساعدك؟",
  "هلا والله أبو حسين، منور يا حج بديع، الله يقويك ويعطيك العافية، كيف صحتك شو أخبارك؟ أنا المساعدة للاستاذ سمير، تفضل شو بneedي؟"
];
const BOSS_FAREWELLS = [
