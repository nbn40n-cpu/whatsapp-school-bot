...
const FULL = {
    ...
    "شحن خفيف": "هلا، إذا بدك رخصة شحن خفيف، عمرك لازم 18 سنة. إذا كان عمرك أقل من 18 (مثلاً 17.5) فبعد ما تنجح بالتوريا والفحص بتستلم أول رخصة خصوصي، وبس يصير عندك 18 سنة بتستلم رخصة الشحن. لازم تجي عالمدرسة نعمل لك معاملة، وبتلزمك 4 صور شخصية بخلفية زرقاء وصورتي هوية، وبعدها الفحص الطبي بمديرية الصحة بواد البقيع، وبيصير صيام وفحص نظر. الدراسة 125 شيكل والتيست الأول 380.",
  ...
  if (has("عمر", "سن", "كم عمر", "السن")) {
    ...
    if (has("شحن خفيف") || has("شحن")) return "شحن خفيف: عمرك 18 سنة، ومن عمر 17.5 بتقدر تبدأ إجراءات، وبعد النجاح بتستلم رخصة خصوصي أول، وبس تصير 18 بتستلم رخصة الشحن.";
