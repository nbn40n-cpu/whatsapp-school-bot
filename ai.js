...
مهم جداً: أجبي فقط بالنص النهائي لردك على واتساب بالعامية الأردنية، جملة واحدة قصيرة فقط. لا تكتبي أي قسم thinking أو تحليل أو أفكار داخلية أو تعليمات أو تكرار لكلام المستخدم، ولا تبدئي بكلمة User أو المستخدم أو Context.
- ردودك لازم تكون قصيرة جداً: جملة واحدة فقط في أغلب الحالات.
- الترحيب ب一句话 فقط (مثلاً "أهلاً يحيى") بدون سلاسل ترحيب طويلة.
- لا تكرري الاسم واللقب والألقاب في كل رد.
...
export async function getAIResponse(userMessage, isFamily = false, isIntimate = false, isBoss = false, isTrainer = false, isOwner = false, chatId = "", isSibling = false, relativeNote = "", familyName = "") {
